...
from model.FCN32_VGG16_3D_Model import Fcn32
...
# data
(x_train, y_train), (x_test, y_test) = creat_minist_3d_seg_data(num_trainData, num_testData)
...
gc.collect()
# model
front_model = cnn_3D_without_dense(input_shape, num_classes)
